...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="../View/index.php">PTE ADMIN</a>
        <!-- Sidebar Toggle-->
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <div class="collapse" id="pagesCollapseArticle" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a id="goToAddArticle" href="../View/article-upload-form.php" class="nav-link">Add article</a>
                                        <a id="goToEditArticle" href="../View/edit-article.php" class="nav-link">Edit article</a>
                                    </nav>
                                </div>
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                ...
                                <div class="collapse" id="pagesCollapseAcc" aria-labelledby="headingOne"
                                    data-bs-parent="#sidenavAccordionPages">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="../View/article-upload-form.php">All Account</a>
                        ...
                        <tbody>
                            <?php foreach ($allArticle as $article): ?>
                                <tr>
                                    ...
                                    <td><a id="" href="./article-upload-form.php?id=<?php echo $article['articleId']?>" type="button" class="btn btn-outline-primary">Edit</a></td>
                                    <td><a id="" href="../Controller/article-action/delete-article.php?id=<?php echo $article['articleId']?>" type="button" class="btn btn-outline-danger">Delete</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    //     $("#goToEditArticle").click(function(event) {
    ...
    // });
    // $(document).ready(function() {
    //     $("#goToAddArticle").click(function(event) {
    //         event.preventDefault();
    //         $.ajax({
    //             type: "POST",
    //             url: '../Controller/login-action/set-action.php',
